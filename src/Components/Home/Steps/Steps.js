...
const Steps = () => {
    return (
        <>
        <div>
            <h1 className="mt-5">Easy step from your phone.</h1>
        </div>
            <Container>
